...
purpose (see _Why flat?_ below). Grouping here is the **runtime layering** — who
...
change the directory cosmetics but _nothing_ about the dependency enforcement,
...
the _dependency DAG_, and it is already enforced structurally by R1–R14 and
