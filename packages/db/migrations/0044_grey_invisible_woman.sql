...
ALTER TABLE "review_verifications" ADD CONSTRAINT "review_verifications_report_id_review_reports_id_fk" FOREIGN KEY ("report_id") REFERENCES "review_reports"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
