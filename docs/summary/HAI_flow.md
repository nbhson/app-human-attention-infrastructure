...
Nguồn: `docs/summary/HAI_overview.md`, `docs/core/1_HAI_Harness_Architecture_v0.1.md`, `docs/core/2_Task_Work_Orchestrator_v0.2.md`, `docs/core/6_Attention_Engine_v0.1.md`.
